...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/emacs-nautilus.py https://raw.githubusercontent.com/Rybski/emacs-nautilus/master/emacs-nautilus.py
